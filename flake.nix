  ...
  outputs =
    ...
    forEachSupportedSystem (
      ...
      in
      {
        ...
        packages.default = pythonSet.mkVirtualEnv "copilotj-env" workspace.deps.default;
        ...
        devShells = {
          ...
          uv2nix =
            let
              ...
              virtualenv = editablePythonSet.mkVirtualEnv "copilotj-dev-env" workspace.deps.all;
